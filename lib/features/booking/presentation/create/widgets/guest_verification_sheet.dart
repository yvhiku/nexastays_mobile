...
/// Guest identity + ID upload step before booking confirmation.
/// Calls `POST /stays/bookings/occupants/upload-id` for each document.
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    ...List.generate(_guests.length, _buildGuestCard),
                    CheckboxListTile(
                      value: _acknowledged,
                      onChanged: (v) =>
