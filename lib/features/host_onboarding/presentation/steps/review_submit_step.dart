...
class ReviewSubmitStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hostIdVerified = state.isListingFlow
        ? state.hostType != null
        : kycVerified;
    final bool photosReady = state.photoPaths.length >= 12; // Step 9
    final bool videoReady = state.videoPath != null && state.videoPath!.isNotEmpty; // Step 10
    final bool pricingSet = state.nightlyRate != null; // Step 7
    final bool checkInReady = state.checkInContact != null && state.checkInContact!.isNotEmpty; // Step 8
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: state.allRequiredComplete
                    ...
                    : null,
                color: state.allRequiredComplete ? null : const Color(0xFFF3F4F6),
              ),
            ...
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.dmSans(
                  ...
                  color:
                      isComplete ? const Color(0xFF166534) : const Color(0xFFb45309), // Darker amber for readability
                ),
              ),
            ),
            if (!isComplete)
